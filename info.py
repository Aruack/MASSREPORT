...
class Config(object):
    ...
    OWNER    = int(os.environ.get("OWNER", "1346413857"))  # ⚠️ Required
    SUDO = list(map(int, os.environ.get("SUDO", "1346413857").split()))  # ⚠️ Required
    # Web Response Config
...
☛ For e.g :- <code> @ </code> or <code> https:/t.me/ll_ADITYA_ll </code>
"""
